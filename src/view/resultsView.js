...
class ResultsView extends View {
  ...
  _generateDOMPreview(data) {
    return `<li class="mb-3 list-group-item d-flex align-items-center">
              <a href="#${data.id}" class="d-flex w-100 align-items-center text-decoration-none recipe-link">
                ...
                <div class="d-flex flex-column recipe-btns">
                  <h5 class="mb-1 text-black">${data.title} 
                  <span class="user ${data.key ? "" : "d-none"}"><i class="fas fa-user m-1"></i></span>
                  </h5>
